...
[![Version](https://img.shields.io/badge/version-v1.1.0--draft-orange)](./CHANGELOG.md)
...
The Open Data Product Standard (ODCS), a Linux Foundation AI & Data Incubation project, is a community-driven standard
distributed as a YAML/JSON document. 
